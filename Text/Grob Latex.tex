...
\caption{Vergleich der Langzeitpotenzierung (Prozent des Ausgangsniveaus) $60\,min$ nach Hochfrequenzstimulation. Bei unbehandelten Tieren gibt es keinen Unterschied zwischen der Verwendung von herkömmlicher Nährlösung ACSF und der modifizierten Nährlösung ACSF/Br, welche NaBr enthält. Der graphische Anstieg der Langzeitpotenzierung bei mit Pilocarpin behandelten Tieren ohne NaBr ist statistisch nicht signifikant. In der mit NaBr behandelten Gruppe der mit Pilokarpin behandelten Tiere liegt die Langzeitpotenzierung auf dem Niveau der unbehandelten Tiere. Insgesamt wurden Messungen an Hippocampusschnitten von sechs unbehandelten Tieren und zwölf mit Pilokarpin behandelten Tieren verwendet.}  
\end{center}
\end{figure}
